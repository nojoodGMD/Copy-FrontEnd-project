  ...
  return (
    ...
    <Card.Title className='cart-title'>Cart List</Card.Title>
      ...
      <div className="home-main-content">
                        ...
                        return(
                            <div key={product.id} className="home__signel-product">
                                ...
                                <Card.Body>
                                    ...
                                    <Button variant="primary" className="home__btn" onClick={()=>handleRemove(product.id)}>Remove from Cart</Button>
                                    </div>
                                </Card.Body>
                                </Card>
                            </div>
                    ...
                    {cartItems.length>0 && <Button variant="primary" onClick={handleRemoveAll}>Remove All Items</Button>}
